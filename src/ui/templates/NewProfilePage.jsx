              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                ...
                {formData.travelCity || formData.travelCountry ? (
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-[#009fe3]/10 rounded-full flex items-center justify-center text-[#009fe3] text-xl">
                      ✈️
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Upcoming destination</p>
                    </div>
                  </div>
                ) : (
